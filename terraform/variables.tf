...
variable "docker_image_url_client" {
  ...
  default     = "709905428434.dkr.ecr.us-west-1.amazonaws.com/test-driven-client-fargate:prod"
}
variable "docker_image_url_users" {
  description = "Docker users image to run in the ECS cluster"
  default     = "709905428434.dkr.ecr.us-west-1.amazonaws.com/test-driven-users-fargate:prod"
}
variable "app_count" {
